  ...
  Drupal.behaviors.ip2country = {
    attach: function () {
      ...
      $('#edit-ip2country-update-database').click(function () {
        ...
        $.get(drupalSettings.path.baseUrl + drupalSettings.path.pathPrefix + 'admin/config/people/ip2country/update/' + $('#edit-ip2country-rir').val(), null, databaseUpdated);
        return false;
      });
      ...
      $('#edit-ip2country-lookup-button').click(function () {
        ...
        $.get(drupalSettings.path.baseUrl + drupalSettings.path.pathPrefix + 'admin/config/people/ip2country/lookup/' + $('#edit-ip2country-lookup').val(), null, lookupCompleted);
        return false;
      });
    }
  };
